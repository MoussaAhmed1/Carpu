            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex flex-column align-items-center text-center">
                  <img
                    src={"http://localhost:3000/assets/nasser.jpg"}
                    alt="Admin"
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-sm-9 text-secondary">MAHMOUD NASSER</div>
                </div>
                <hr />
                <div className="row">
                  <div className="col-sm-3">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9 text-secondary">02154565522</div>
                </div>
                <hr />
                <div className="row">
                  <div className="col-sm-3">
                  ...
                  <div className="col-sm-9 text-secondary">0215466461</div>
                </div>
                <hr />
                <div className="row">
                  <div className="col-sm-3">
                  ...
                  <div className="col-sm-9 text-secondary">LUXOR , ESNA</div>
                </div>
              </div>
            </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">222</div>
                      </div>
                    </div>
                    <hr />
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">122</div>
                      </div>
                    </div>
                    <hr />
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">100</div>
                      </div>
                    </div>
                    <hr />
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">8</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">KIA</div>
                      </div>
                    </div>
                    <hr />
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">2022</div>
                      </div>
                    </div>
                    <hr />
                    <div className="row ">
                      <div className=" d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="col-sm-3 text-secondary">Black</div>
                      </div>
                    </div>
                  </div>
                </div>
